...
import { mergeConfigs, loadGlobalConfig, bootstrapGlobalConfig, saveGlobalConfig } from '../src/utils/config/index.js';
...
describe('proxy flow E2E', () => {
    ...
    it('config merge produces correct resolved routes', async () => {
        ...
        global.groups['test'] = { routes: [{ domain: 'test.local', target: 9999 }] };
